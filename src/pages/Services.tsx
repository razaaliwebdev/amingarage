...
const Services: React.FC = () => {
  const services = [
    {
      ...
      description:
        "Regular oil changes and preventive maintenance to keep your engine running smoothly.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete brake system inspection, repair, and replacement for your safety.",
      features: [
    ...
    },
    {
      ...
      description:
        "Professional tire services including mounting, balancing, and repairs.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete air conditioning system repair and maintenance services.",
      features: [
    ...
    },
    {
      ...
      description:
        "Expert transmission repair and maintenance for smooth operation.",
      features: [
  ...
  return (
    <div className="pt-24">
      ...
      <section className="py-20 bg-gradient-to-br from-red-600 to-red-800 text-[#C0C0C0]">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-red-100">
            ...
            complex repairs, all performed by certified technicians using
            quality parts.
          </p>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-red-500 text-[#C0C0C0]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="bg-[#C0C0C0] text-red-500 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-300"
            >
              Schedule Service
            </a>
            <a
              href="tel:+923076552348"
              className="border-2 border-[#C0C0C0] text-[#C0C0C0] hover:bg-white hover:text-orange-500 px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-300"
            >
              Call Now
            </a>
          </div>
