  ...
  const blogPosts = [
    {
      ...
      excerpt: "Prepare your vehicle for winter weather with these essential maintenance tips that will keep you safe on the road.",
    ...
    },
    {
      ...
      excerpt: "Learn to recognize the warning signs that indicate your brake system needs professional inspection and repair.",
    ...
    },
    {
      ...
      excerpt: "Understanding the different types of motor oil and how to select the best one for your vehicle's specific needs.",
    ...
    },
    {
      ...
      excerpt: "Modern vehicles rely on complex computer systems. Learn why regular diagnostic checks are crucial for your car's health.",
    ...
    },
    {
      ...
      excerpt: "Proper tire maintenance can save you money and keep you safe. Here's everything you need to know about tire care.",
    ...
    },
    {
      ...
      excerpt: "Don't wait until summer to check your AC. Learn about the importance of regular air conditioning maintenance.",
    ...
    <div className="pt-24">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Automotive Blog</h1>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            ...
            />
            <button className="bg-orange-500 hover:bg-orange-600 px-6 py-3 rounded-lg font-semibold transition-colors duration-300">
              Subscribe
            </button>
          </div>
        </div>
