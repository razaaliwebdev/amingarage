        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm relative z-10">
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            <div className="flex items-center space-x-2 group">
              ...
              <span className="hover:text-orange-300 transition-colors duration-200">+1 (555) 123-4567</span>
            </div>
            <div className="flex items-center space-x-2 group">
              <Mail className="w-4 h-4 text-orange-400 group-hover:scale-110 transition-transform duration-300" />
              <span className="hover:text-orange-300 transition-colors duration-200">contact@primegarage.com</span>
            </div>
            <div className="flex items-center space-x-2 group">
              <MapPin className="w-4 h-4 text-orange-400 group-hover:bounce transition-transform duration-300" />
              <span className="hover:text-orange-300 transition-colors duration-200">123 Main St, Downtown NY</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className={`p-2 rounded-xl transition-all duration-300 ${
                ...
                <Wrench className={`w-8 h-8 transition-all duration-300 group-hover:rotate-12 ${
